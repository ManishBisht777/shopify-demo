    ...
    mounted && (
      <div>
        <div className="h-full bg-slate-50 flex">
          <div className="w-1/2 flex items-center flex-col p-10">
            ...
            <Swiper
              ...
              slidesPerView={4}
              modules={[Navigation, Thumbs]}
              className="w-full productimageswiperthumbs my-5"
              ...
              {images.edges.map((image) => {
                return (
                  <SwiperSlide
                    ...
                    className="flex justify-center"
                  >
                    <div className="productimageswiperthumbswrapper">
                      <img
                        src={image.node.url}
                        alt="hehe"
        ...
        <div className="flex justify-center  p-10 w-full bg-slate-100 flex-col items-center">
          <h4 className="text-4xl leading-10 text-pink-500 py-3 ">
            How do I use it?
          </h4>
        ...
        <div className="flex justify-center items-center w-full bg-slate-200 "></div>
      </div>
    )
  );
};
